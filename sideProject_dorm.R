...
#第二層的相減 -1代表 1 0 代表第一層 符合值接著出現 符合值結束退策會出現 第一層 1 0  所以第二層會是-1
...
#死亡守衛的新手包size內容物和價格 估算折扣
#結論 若配合店家9折 則可以達到80.5折
combat_price = data.frame(walker=960*2,typhus = 1200, plague_marine = 1440)
combat_price
4080*0.9/sum(combat_price)*100
